...
preds <- urban_table %>% 
  ...
  mutate(predoutcome = predlean + 2.6)
...
polls <- tibble(
  ...
  avg = c(-0.5, -6, -0.1, -1.7, 0.1, -0.6, -1.6, 0.3, 25, -19, -7.2, -6, 28.8, 29.3, 6, 7.6, 9, -5, -27, -10, -9, -16.5, 18.5, 13.5, 11, 7.6, 16, 16.5, 13, -11.5, -15, 21, -16, -17, -27, -32, 41, 5, -25.4, 29.4, -30.7, 16.9, -14.6, -26, -18.6, -16.5, 15.8, -25.8, -23.3, -43.3)
)
...
However, in reality this is a much closer contest than it appears: a shift of just 2.15 points to the right nationally would flip Michigan, Minnesota, Texas and, in the height of irony, Vermont, giving Trump exactly the 270 electoral votes needed to be the next President of the United States. Even ignoring Vermont, he would only have to make up an additional 0.12 points to win the aforementioned Oregon, and if the polls were off by about 4 points in Trump's favor, as they were in 2020, he would take back Pennsylvania and Florida, as well as Maine's 1st district for good measure, enough for a comfortable Electoral College victory.
...
[Geographic data](https://www.census.gov/geographies/mapping-files/time-series/geo/carto-boundary-file.html)<br> [Polls](https://www.270towin.com/2024-presidential-election-polls/) (accessed on October 15)<br> [Electoral votes](https://www.kaggle.com/datasets/mikedelong/2024-electoral-college-votes-available?resource=download)<br> [Urbanization, and](https://github.com/fivethirtyeight/data/tree/master/district-urbanization-index-2022)<br> [Urbanization (for DC)](https://github.com/fivethirtyeight/data/tree/master/urbanization-index)<br> [Population data](https://www.census.gov/data/tables/time-series/demo/popest/2020s-state-total.html)
