...
preds <- urban_table %>% 
  ...
  mutate(predoutcome = predlean + 1.4)
...
polls <- tibble(
  ...
  avg = c(-1.9, -6.6, -0.3, -1.7, 0.2, 0.3, -0.6, 0.4, 24.7, -19, -6.4, -5.6, 29.2, 28.5, 6.5, 7.6, 9, -5, -27, -10, -7, -16.5, 18.5, 16.5, 11, 7, 16, 16.5, 13, -11.5, -15, 20.6, -16, -17, -27, -16, 41, 12, -25.4, 29.4, -30.7, 16.9, -14.6, -26, -18.6, -16.5, 15.8, -25.8, -21, -43.3)
)
...
NOTE: polls last updated October 23
